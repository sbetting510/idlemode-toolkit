const SAVES = [
    { ability: 'Strength',     triggers: 'Grapple escape, Thunderwave, push effects, Hold Monster (Str)', range: '12–18' },
    { ability: 'Dexterity',    triggers: 'Fireball, breath weapons, traps, most area spells, Evasion',    range: '13–18' },
    { ability: 'Constitution', triggers: 'Concentration checks, poison, disease, massive damage',         range: '10–18' },
